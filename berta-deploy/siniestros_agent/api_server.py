...
def _parse_berta_response(
    ...
    if "REHUSAR" in texto_upper or "REHÚSO" in texto_upper or "REHÚSE" in texto_upper or "REHÚSA" in texto_upper:
        decision = DecisionBerta.REHUSAR
    elif "SOLICITAR DOCUMENTACIÓN" in texto_upper or "CÓDIGO 301" in texto_upper or "CODIGO 301" in texto_upper:
        decision = DecisionBerta.SOLICITAR_DOC
    elif "ACEPTAR CON RESERVAS" in texto_upper or "CÓDIGO 300" in texto_upper or "CODIGO 300" in texto_upper:
        decision = DecisionBerta.ACEPTAR_RESERVAS
    elif "ACEPTAR" in texto_upper or "CÓDIGO 200" in texto_upper or "CODIGO 200" in texto_upper:
    ...
    if m:
        ...
        decision_to_code = {
            DecisionBerta.ACEPTAR: "200",
            DecisionBerta.ACEPTAR_RESERVAS: "300",
            DecisionBerta.SOLICITAR_DOC: "301",
            DecisionBerta.REHUSAR: "900",
        }
...
async def siax_analizar_mensaje(request: SiaxAnalisisMensajeRequest):
    ...
    **Botón 2 — Analizar Mensaje y Recomendar Respuesta.**
    ...
    # 5. Devolver datos del mensaje + análisis
    return {
        "id_cas": request.id_cas,
