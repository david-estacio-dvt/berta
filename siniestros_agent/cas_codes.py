...
CAS_CODES = {
    ...
    # --- Códigos 7xx: Avisos ---
    "701": {
        "nombre": "Aviso envío fuera de plazo (Centro Compensador)",
        "descripcion": "Aviso emitido por el Centro Compensador (CS) cuando el parte de urgencias se envía fuera de plazo (más de 15 días naturales desde la asistencia). REGLA DE NEGOCIO: Implica una penalización/regularización del 10% sobre el importe total de la factura asociada. Este código es OFICIAL y VÁLIDO en todos los convenios (público, privado, 2010U). NO debe tratarse como anomalía.",
        "emisor": "CENTRO_COMPENSADOR",
        "tipo": "AVISOS",
        "regla_negocio": "Regularización del 10% sobre importe total de factura",
    },
    "715": {
...
# ============================================================
# FILTRADO DE CÓDIGOS POR CONVENIO
# ============================================================

CONVENIO_NORMAS_MAP = {
    "10199": "SANIDAD_PUBLICA",
    "10111": "SANIDAD_PUBLICA",
    "10209": "SANIDAD_PUBLICA",
    "2010U": "CLINICAS_PRIVADAS",
    "2010u": "CLINICAS_PRIVADAS",
}

CODIGOS_EXCLUSIVOS_PRIVADO = {
    "422", "423", "442", "443",
    "361", "364", "373", "383", "384", "861", "864",
    "655", "665",
...
CODIGOS_EXCLUSIVOS_PUBLICO = {
    "175", "176", "476", "485",
    "504",
    "325", "574",
}

TRANSICIONES_RESPUESTA_POR_CONVENIO = {
    "SANIDAD_PUBLICA": {
        "101": ["201", "401", "471", "472", "492", "494"],
        "171": ["271", "471", "472", "473", "474", "475", "492", "494", "495", "496", "497", "498", "499"],
        "172": ["271", "471", "472", "473", "474", "475"],
        "173": ["271", "471", "472", "473"],
        "174": ["271", "471", "472", "473"],
        "175": ["271", "471", "472", "475", "476"],
        "176": ["271", "471", "476"],
        "181": ["281", "481", "482", "483", "485", "486", "368"],
        "191": ["271", "471"],
        "192": ["271", "471"],
        "301": ["202", "311", "362"],
        "302": ["303", "304", "305"],
    ...
    "CLINICAS_PRIVADAS": {
        "101": ["201", "401", "471", "472", "422", "492", "494"],
        "171": ["271", "471", "472", "473", "474", "475", "477", "422", "492", "494", "495", "496", "497", "498", "499"],
        "172": ["271", "471", "472", "473", "474", "475", "477"],
        "173": ["271", "471", "472", "473"],
        "174": ["271", "471", "472", "473"],
        "181": ["281", "481", "482", "483", "486", "487", "488", "442", "368"],
        "191": ["271", "471"],
        "192": ["271", "471"],
        "301": ["202", "311", "362"],
        "302": ["303", "304", "305"],
...
def normalizar_convenio(convenio_normas: str) -> str:
    """Normaliza el código de convenio a un tipo reconocido."""
    if not convenio_normas:
        return "GENERICO"
    clave = convenio_normas.strip()
    return CONVENIO_NORMAS_MAP.get(clave, "GENERICO")


def get_codigos_respuesta_por_convenio(codigo_mensaje: str, convenio_normas: str) -> list:
    """
    Devuelve los códigos de respuesta válidos para un mensaje,
    filtrados por el convenio aplicable.
    """
    tipo_convenio = normalizar_convenio(convenio_normas)

    if tipo_convenio in TRANSICIONES_RESPUESTA_POR_CONVENIO:
        tabla = TRANSICIONES_RESPUESTA_POR_CONVENIO[tipo_convenio]
        if codigo_mensaje in tabla:
            return tabla[codigo_mensaje]

    from_general = CAS_TRANSITIONS.get(codigo_mensaje, [])
    if from_general:
        return from_general
